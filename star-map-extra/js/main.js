...
const generateGalaxy = () => {
  ...
  const cleanedStars = addLatLon(starsDataHyg, globalUniforms.magLimit.value);

  globalUniforms.uSizeFactor.value = sizeFactorScale(
    globalUniforms.magLimit.value
  );

  // console.log(globalUniforms.magLimit.value);
...
gui
  ...
  .listen();
gui
  .add(globalUniforms.magLimit, 'value')
  .min(0)
  .max(50)
  .step(0.1)
  .name('Magnitude')
...
const tick = () => {
  ...
  // material.uniforms.uSizeFactor.value = globalUniforms.uSizeFactor.value;
...
const startSequence = () => {
  ...
  globalUniforms.magLimit.value = 1;

  gsap.to(globalUniforms.magLimit, {
    delay: 0,
    duration: 10,
    value: '+=10',
    ease: 'linear',
    onUpdate: () => {
      // console.log('on update ', globalUniforms.magLimit.value);
      generateGalaxy();
    },
    onStart: () => {
      // console.log('on start ', globalUniforms.magLimit.value);
      // running = true;
    },
    onComplete: () => {
      // console.log('on complete ', globalUniforms.magLimit.value);
